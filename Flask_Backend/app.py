...
def PredictCropWithReact(nitrogen, phosphorus, potassium, temperature, humidity, ph, rainfall):
    ...
    return {"detail": "<p> <h6>Sir according to the data that you provided to me.</h6> <ul> <li>The ratio of nitrogen in the soil is  " + nitrogen_level + ".</li>" + " \n <li>The ratio of phosphorus in the soil is  " + phosphorus_level + ".</li>" + "<li> The ratio of potassium in the soil is  " + potassium_level + ".</li>" + "<li> The temperature level around the field is" +
            temperature_level + ".</li> " + "<li>The humidity level around the field is  " + humidity_level + ".</li>" + "<li>The ph type of the soil is  " + phlevel + ".</li>" + "<li> The amount of rainfall is  " + rainfall_level + ".</li>" + "</ul></p>", "crop_name": crop_name}
